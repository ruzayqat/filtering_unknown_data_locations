...
coord = 2;
dimx = 2500;%20736;%16384; %1600;
dimy = 625;%5184; %4096; %400;
...
smcmcf1 = squeeze(smcmc_h(coord,:,:));

filename = strcat(enkf_loc_dir,'/enkf_loc.h5');
...
set(0,'defaultfigurecolor',[1 1 1])
    ...
    figure
    set(gcf, 'Position',  [300, 400, 600, 600])
    h1 = histogram(abs_err_smcmc);
    ...
    title(sprintf('SMCMC: Histogram of Absolute Errors ($\\bar{\\sigma}_y=%.2E$)',sig_y), 'FontSize', 27)
    ...
    figure
    set(gcf, 'Position',  [100, 600, 600, 600])
    ...
    axx.XAxis.FontSize = 28;
    axx.YAxis.FontSize = 22;
    title(sprintf('EnKF Local: Histogram of Absolute Errors ($\\bar{\\sigma}_y=%.2E$)',sig_y), 'FontSize', 27)
    xlabel('Absolute Error', 'FontSize', 30)
    ylabel('Percentage of Occurrence',  'FontSize', 30)
...
%%   
    ...
    figure
    set(gcf, 'Position',  [1000, 700, 600, 600])
